...
<div id="inscription" style="display:none;">
    ...
    <div id="insContenu">
        <div id="inscBandeau">
			    ...
			    <div id="zonevalider" onMouseOver="verifForm()">
                            <button id="btnValider" type="submit" id="signUpButton" class="btBlue btBig txtShadS btAjaxSubmit tooltip-on btInactive inactive" >S'inscrire</button></div>  <span class="bomdialog-action-loader h"></span>
                        </form>
                    </div>
